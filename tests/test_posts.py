...
class TestPosts:
    def test_get_all_posts(self, posts_url):
    ...
    def test_get_single_post(self, posts_url):
    ...
    def test_create_post(self, posts_url, sample_post):
    ...
    def test_update_post(self, posts_url, sample_post):
    ...
    def test_delete_post(self, posts_url):
